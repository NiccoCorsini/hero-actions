 ...
 * ```
 */
export declare const createActionForPayloads: <Payloads extends PayloadsTree>() => <T extends Extract<keyof Payloads, string>>(type: T) => Payloads[T] extends undefined ? () => Action<T> : (payload: Payloads[T]) => ActionWithPayload<T, Payloads[T]>;
